...
![Busqueda de un recurso e importación en nuestro script](img/Buscador.png)
...
![Mensajes para conmvertir a Feture Collection](img/convertImport.png)
...
![Ejemplo de tabla exportada](img/EjemploTablaExportada.png)


## Resumen: mapa conceptual de la lección

![Mapa Conceptual de la lección 6](img/GEE_Lesson_6.png)