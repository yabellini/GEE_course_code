...
En [esta presentación](pdf/Google_Earth_Engine_TallerCAI2019.pdf) hay mas detalles sobre su funcionamiento, la información disponible y que tipo de productos y análisis se pueden realizar.
...
![Partes del editor de código](img/CodeEditor.png) 
...
![Hola Mundo con Java en GEE](img/HolaMundo.png) 



## Resumen: mapa conceptual de la lección

![Mapa Conceptual de la lección 1](img/GEE_Lesson_1.png)
