...
![Secuencia de pantallas para cargar un shape file a GEE](img/CargarAssets.png)
...
![Secuencia de pantallas para cargar un shape file a GEE](img/Import.png)
...
![Secuencia de pantallas para generar una geometría en el editor de código](img/GenerarGeometriaMapa.png)


![Segunda secuencia de pantallas para generar una geometría en el editor de código](img/GenerarGeometriaMapa2.png)


## Resumen: mapa conceptual de la lección

![Mapa Conceptual de la lección 1](img/GEE_Lesson_4.png)
