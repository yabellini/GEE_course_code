...
![Archivo CSV de ejemplo con coordenadas decimales](EjemploCSV.png)
...
![Exportando una FC a Google Drive](img/ExportarFC.png)

## Resumen: mapa conceptual de la lección

![Mapa Conceptual de la lección 5](img/GEE_Lesson_5.png)